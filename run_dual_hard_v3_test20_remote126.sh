...
export GPU_ID
export RUN_ROOT="${RUN_ROOT:-$ROOT/tmp/dual_hard_v3_test20_gpu${GPU_ID}}"
export INPUT_SAMPLE_NUM="${INPUT_SAMPLE_NUM:-60}"
...
export REFLECTVPR_WEATHER_THRESHOLD="${REFLECTVPR_WEATHER_THRESHOLD:-0.58}"
export REFLECTVPR_OCCLUSION_THRESHOLD="${REFLECTVPR_OCCLUSION_THRESHOLD:-0.62}"

# Hardest dual prompt so far: strong weather + VPR-salient lower-structure occlusion.
export REFLECTVPR_DUAL_PROMPT_STRATEGY=dual_hard_v3
