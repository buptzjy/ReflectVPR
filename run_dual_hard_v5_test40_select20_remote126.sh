...
export GPU_ID
export RUN_ROOT="${RUN_ROOT:-$ROOT/tmp/dual_hard_v5_test40_select20_gpu${GPU_ID}}"
...
# v5: hard but structure-preserving, no new architecture/window/facade hallucination.
export REFLECTVPR_DUAL_PROMPT_STRATEGY=dual_hard_v5
